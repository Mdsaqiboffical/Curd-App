...
// function editPost(id) {
//     document.querySelector("#updatePostForm").addEventListener("submit", (e) => {
//         e.preventDefault();
    
//         editPostModal.style.display = "block";
//         let editPostName = document.getElementById("edit-name").value;
//         let editPostTitle = document.getElementById("edit-title").value;
//         let editPostAvatar = document.getElementById("edit-avatar").value;
//         let editPostURL = document.getElementById("edit-postURL").value;
//         let editPostbody = document.getElementById("edit-body").value;

//         const updatePost = {
//             name: editPostName,
//             title: editPostTitle,
//             avatar: editPostAvatar,
//             postURL: editPostURL,
//             body: editPostbody,
//         }
